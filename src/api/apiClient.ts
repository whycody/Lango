...
export const syncWordsOnServer = async (
  words: Word[],
): Promise<SyncResult[]> => {
  try {
    return await apiCall({
...
export const syncSessionsOnServer = async (
  sessions: Session[],
): Promise<SyncResult[]> => {
  try {
    return await apiCall({
...
export const fetchUpdatedSessions = async (
  since: string,
): Promise<Session[]> => {
  try {
    return await apiCall({
...
export const fetchUpdatedEvaluations = async (
  since: string,
): Promise<Evaluation[]> => {
  try {
    return await apiCall({
